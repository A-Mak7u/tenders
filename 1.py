...
KEYWORDS = [
    "Бытовки", "Дачные домики", "Вагончики садовые", "Блок-контейнеры",
    "Блок-контейнеры в г. Самара", "Бытовки в Балаково", "Бытовки в Пензе",
    "Бытовки в Саратове", "Бытовки в Энгельсе", "Бытовки в Вольске",
    "Бытовки в Марксе", "Бытовки дачные", "Бытовки, блок-контейнеры в Волгоград"
]
...
def get_tenders(keyword):
    ...
    for item in soup.select(".search-registry-entry-block"):  # Класс элементов тендеров
