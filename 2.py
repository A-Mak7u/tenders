...
# Близкие города и регионы к Саратову
NEARBY_CITIES = [
    "Саратов", "Самара", "Пенза", "Энгельс", "Балаково", "Вольск", "Маркс", "Волгоград"
]
...
KEYWORDS = [f"{product} в {city}" for product in PRODUCTS for city in NEARBY_CITIES] + PRODUCTS
